...
export default function Sidebar(){
  ...
  const logout = async () => {
    ...
    try {
      const resttt = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/logout`, {
        method: "POST",
        headers: {
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="/requests" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Add Requests</span>
            </a>
         </li>
         <li>
            <a href="/redeem" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Pending Generated Request</span>
            </a>
         </li>
         ...
         <li>
            <a href="/graph" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Last 6 weeks request</span>
            </a>
         </li>
         {/* <li>
         ...
         <li>
            <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <button onClick={logout} className="flex-1 ms-3 whitespace-nowrap">Logout</button>
            </a>
         </li>
      </ul>
   </div>
